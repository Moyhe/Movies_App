    ...
    <div class="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between px-4 py-6">
        <ul class="flex flex-col md:flex-row items-center">
            ...
            <li class="md:ml-16 mt-3 md:mt-0">
                <a href="{{route('movies.index')}}" class="hover:text-gray-500 dark:hover:text-gray-300">Movies</a>
            </li>
            <li class="md:ml-6 mt-3 md:mt-0">
                <a href="{{ route('tvs.index') }}" class="hover:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300">TV Shows</a>
            </li>
            <li class="md:ml-6 mt-3 md:mt-0">
                <a href="{{ route('actors.index') }}" class="hover:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300">Actors</a>
            </li>
        </ul>
        <div class="flex flex-col md:flex-row items-center">

            <div class="md:ml-4 mt-3 me-6 md:mt-0">
                <div>
                <x-toggle-theme />
                </div>
            </div>
